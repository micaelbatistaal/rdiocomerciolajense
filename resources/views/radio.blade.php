...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .radio-card{
      width:100%; max-width:560px; background:var(--card); border-radius:24px; padding:28px;
      box-shadow:0 20px 60px rgba(0,0,0,.35); text-align:center; border:1px solid rgba(255,255,255,.06);
    }
    .radio-logo{
      width:180px; height:180px; overflow:hidden; margin:0 auto 18px;
    ...
    .play-btn{
      ...
      box-shadow:0 10px 30px rgba(212, 219, 29, 0.35);
    ...
    @media (max-width:560px){
      .radio-logo{ width:140px; height:140px }
  ...
  <div class="radio-wrap">
    <div class="radio-card" role="region" aria-label="Player da rádio">
      ...
      <audio id="radioAudio" preload="none" crossorigin="anonymous"
             src="{{ $stream ?? 'https://stm10.conectastreaming.com:6890/stream' }}"></audio>
    </div>
  </div>
